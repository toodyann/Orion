  ...
  <aside class="sidebar">
    ...
    <div class="profile-menu-wrapper">
      <button class="btn-profile" id="profileMenuBtn" title="Меню">
        <span class="profile-menu-avatar" aria-hidden="true"></span>
        <span class="profile-menu-name" id="profileMenuName">Користувач Orion</span>
      </button>
      
      <button class="btn-messenger-settings" id="messengerSettingsBtn" title="Налаштування месенджера">
