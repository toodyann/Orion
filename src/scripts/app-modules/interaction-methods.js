...
export class ChatAppInteractionMethods {
  ...
  getDesktopSecondaryMenuItemIcon(iconName = 'gear') {
    const icons = {
      ...
      flappy: '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 256 256"><path d="M203.63,79.72a60,60,0,0,0-94.57-43.51,8,8,0,1,0,10.2,12.33,44,44,0,1,1,68.31,54.37,8,8,0,1,0,10.06,12.44A59.64,59.64,0,0,0,203.63,79.72ZM152,160a40,40,0,1,1-80,0c0-22.06,16.45-33,28.53-39.62a8,8,0,0,0-7.56-14.1C77.38,114.7,56,131.89,56,160a56,56,0,0,0,112,0,8,8,0,0,0-16,0Zm80-24a8,8,0,0,0-8-8H184a8,8,0,0,0,0,16h40A8,8,0,0,0,232,136Z"></path></svg>',
